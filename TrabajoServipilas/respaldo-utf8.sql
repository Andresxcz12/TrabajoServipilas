...
--
-- Name: pedidos; Type: TABLE; Schema: public; Owner: crm_user
--
...
ALTER TABLE public.pedidos OWNER TO crm_user;

--
-- Name: pedidos_id_seq; Type: SEQUENCE; Schema: public; Owner: crm_user
--
...
ALTER SEQUENCE public.pedidos_id_seq OWNER TO crm_user;

--
-- Name: pedidos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: crm_user
--
...
--
-- Name: pedidos id; Type: DEFAULT; Schema: public; Owner: crm_user
--
...
--
-- Data for Name: pedidos; Type: TABLE DATA; Schema: public; Owner: crm_user
--
...
--
-- Name: pedidos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: crm_user
--
...
--
-- Name: pedidos pedidos_pkey; Type: CONSTRAINT; Schema: public; Owner: crm_user
--
